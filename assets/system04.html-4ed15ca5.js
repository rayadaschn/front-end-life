...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9);function b(h,k){const a=o("ExternalLinkIcon");return i(),t("div",null,[r,d,n("p",null,[s("代理软件: "),n("a",u,[s("ClashX"),l(a)]),s(" , 软件的终端混合代理端口号默认为: "),v,s(" HTTP 代理端口号 和 Socks5 代理端口号默认未设置。")]),m])}const x=e(p,[["render",b],["__file","system04.html.vue"]]);export{x as default};
