import{_ as n,X as s,Y as a,$ as t}from"./framework-97fa2d96.js";const p={},e=t,o=s,c=a,l=e(`<p>该文为上篇<a href="./hooks01">《手写一个具备拖拉拽多功能的弹窗》</a>的延续。</p><p>首先需要区分 <code>e.clientX</code> 和 <code>e.offsetX</code> 的区别:</p><ul><li><code>e.clientX</code> 是相对于整个文档左上角的坐标。</li><li><code>e.offsetX</code> 是相对于触发事件的元素左上角的坐标。</li></ul><p>设计思路:</p><ol><li>绘制获取 Canvas 元素。</li><li>创建存储绘制矩形的数组, 后续依据这个数组来遍历绘制矩阵;</li><li>创建绘制矩阵的类, 包含绘制矩阵的方法, 以及矩形的四角信息;</li><li>监听 Canvas 的鼠标按下事件 onmousedown, 分俩种情况, 一种是点击了已绘制矩形, 另一种是点击了空白处开始绘制矩形;</li><li>创建判断是否是绘制块, 创建依据遍历绘制数组, 绘制 Canvas。</li></ol><p>关键代码:</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 创建 Canvas</span>
