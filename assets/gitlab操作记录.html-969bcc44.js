...
// <span class="token number">5.1</span> 删除开发分支
...
</code></pre><p><strong>--mixed :</strong> 【默认参数】不删除工作空间改动代码，<strong>撤销 commit</strong>，并且 **撤销 <code>git add .</code> **</p><p>简单的讲，正常提交是： <code>git add .</code> --&gt; <code>git commit</code></p><p>对应的回退版本是: <code>git reset --soft</code> --&gt; <code>git reset --mixed</code></p></blockquote></li></ul><ol><li>如果我们的有两次 commit 但是没有 push 代码</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">git</span> reset HEAD~1      //撤销前一次 commit，所有代码回到 Working Copy
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h2>`,3),G={href:"https://jdf2e.github.io/jdc_fe_guide/docs/git/branch",target:"_blank",rel:"noopener noreferrer"},q={href:"https://www.runoob.com/git/git-basic-operations.html",target:"_blank",rel:"noopener noreferrer"},y={href:"https://godbasin.github.io/2019/11/10/change-log/",target:"_blank",rel:"noopener noreferrer"},B={href:"https://www.ruanyifeng.com/blog/2012/07/git.html",target:"_blank",rel:"noopener noreferrer"},N={href:"https://segmentfault.com/q/1010000002477106",target:"_blank",rel:"noopener noreferrer"};function w(E,H){const e=r("ExternalLinkIcon");return l(),o("div",null,[d,n("h2",p,[u,s(),n("a",m,[s("常用的 GIT 操作指令"),a(e)])]),g,n("p",null,[s("若有代码迭代问题，可以考虑是否 加入 "),v,s(" 做持续集成， 本文对此概念做简单介绍， 详细可以参考 [官方文档]("),n("a",b,[s("https://about.gitlab.com/resources/scaled-ci-cd/?utm_medium=cpc&utm_source=google&utm_campaign=singleappci_amer_pr_rsa_nb_exact_&utm_content=scaled-ci-cd_digital_x-pr_english_&&utm_term=ci"),a(e)]),s(" cd&_bt=626050032714&_bk=ci cd&_bm=b&_bn=g) 。")]),h,n("h2",k,[f,s(" 利用 "),n("a",x,[s("git-gz"),a(e)]),s(" 规范代码提交")]),_,n("ul",null,[n("li",null,[s("自动生成 "),n("strong",null,[n("a",$,[s("CHANGELOG–conventional-changelog-cli"),a(e)])])])]),C,n("ul",null,[n("li",null,[n("a",G,[s(" JDC 前端代码规范 (jdf2e.github.io)"),a(e)])]),n("li",null,[n("a",q,[s("Git 基本操作 "),a(e)])]),n("li",null,[n("a",y,[s("前端 CHANGELOG 生成指南"),a(e)])]),n("li",null,[n("a",B,[s("Git 分支管理"),a(e)])]),n("li",null,[n("a",N,[s("Git --no--ff"),a(e)])])])])}const z=t(c,[["render",w],["__file","gitlab操作记录.html.vue"]]);export{z as default};
