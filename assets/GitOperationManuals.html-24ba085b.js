...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>注意！当我们使用强制指令时，若在远程的该分支中有他人的贡献，<code>--force</code> 是会覆盖掉他人的代码的，所以为了保险起见，应当用 <code>--force-with-lease</code> 。</p></blockquote></li><li><p>只回退某个指定文件到指定版本</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">git</span> reset a4e21523xxxxxxxxx68e9976948a35e <span class="token punctuation">[</span>options<span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ol><p><strong>汇总</strong>：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 恢复暂存区的指定文件到工作区</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h2>`,3),S={href:"https://jdf2e.github.io/jdc_fe_guide/docs/git/branch",target:"_blank",rel:"noopener noreferrer"},V={href:"https://www.runoob.com/git/git-basic-operations.html",target:"_blank",rel:"noopener noreferrer"},T={href:"https://godbasin.github.io/2019/11/10/change-log/",target:"_blank",rel:"noopener noreferrer"},F={href:"https://www.ruanyifeng.com/blog/2012/07/git.html",target:"_blank",rel:"noopener noreferrer"},j={href:"https://segmentfault.com/q/1010000002477106",target:"_blank",rel:"noopener noreferrer"};function M(Y,K){const e=t("ExternalLinkIcon"),l=t("RouterLink");return k(),f("div",null,[x,n("ol",null,[$,n("li",null,[_,n("ul",null,[y,n("li",null,[G,n("p",null,[q,s("为隐私邮箱，具体设置可看"),n("a",C,[s("GitHub 设置提交电子邮箱地址"),a(e)])])])])]),n("li",null,[E,n("p",null,[s("若无 GPG 秘钥，可看 "),a(l,{to:"/SystemRequirements/GIthubAddGPG.html"},{default:h(()=>[s("GIthub 添加 GPG 签名")]),_:1}),s(" 一文。")]),w])]),N,n("h2",H,[A,s(),n("a",D,[s("常用的 GIT 操作指令"),a(e)])]),B,n("h2",I,[z,s(" 利用 "),n("a",L,[s("git-gz"),a(e)]),s(" 规范代码提交")]),O,n("ul",null,[n("li",null,[s("自动生成 "),n("strong",null,[n("a",R,[s("CHANGELOG–conventional-changelog-cli"),a(e)])])])]),P,n("ul",null,[n("li",null,[n("a",S,[s("JDC 前端代码规范 (jdf2e.github.io)"),a(e)])]),n("li",null,[n("a",V,[s("Git 基本操作"),a(e)])]),n("li",null,[n("a",T,[s("前端 CHANGELOG 生成指南"),a(e)])]),n("li",null,[n("a",F,[s("Git 分支管理"),a(e)])]),n("li",null,[n("a",j,[s("Git --no--ff"),a(e)])])])])}const J=o(b,[["render",M],["__file","GitOperationManuals.html.vue"]]);export{J as default};
