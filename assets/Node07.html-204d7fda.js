...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后，当不记得指令时，请善用 <code>nvm --help</code> 查看帮助！这个比搜指令快的多。</p></li>`,2);function q(V,B){const a=u("ExternalLinkIcon");return b(),k("div",null,[h,_,g,n("p",null,[s("官方文档: "),n("a",f,[s("Nvm 官方文档"),l(a)])]),N,n("ol",null,[n("li",null,[$,n("p",null,[n("a",w,[s("Homebrew"),l(a)])]),j]),x])])}const T=i(v,[["render",q],["__file","Node07.html.vue"]]);export{T as default};
