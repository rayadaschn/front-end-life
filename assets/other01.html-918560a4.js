...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过如上三个设置，就能统一换行编码风格为 “ \\n ”。</p>`,37);function V(w,L){const a=v("ExternalLinkIcon");return m(),b("div",null,[q,n("p",null,[s("在团队开发中，统一代码规范是必不可少的。"),n("a",g,[y,e(a)]),s(" 是我们前端工程化中代码检测的一款常用工具。它不仅可以检测 "),f,s(" 还支持 "),h,s(" 和 "),_,s(" 。")]),x,S,n("p",null,[s("环境要求: "),n("a",j,[s("Node.js"),e(a)]),s(" (>=6.14), npm version 3+。")]),E])}const P=t(d,[["render",V],["__file","other01.html.vue"]]);export{P as default};
