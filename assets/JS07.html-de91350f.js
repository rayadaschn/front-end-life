...
\`\`\`
`)],-1);function j(_,h){const a=k("ExternalLinkIcon");return m(),b("div",null,[y,n("p",null,[s("当然，深拷贝不止于此，还有各种函数、正则等深拷贝。可以看该文"),n("a",g,[s("《JS 从零手写一个深拷贝（进阶篇）》"),d(a)]),s("。")]),f,w])}const S=p(r,[["render",j],["__file","JS07.html.vue"]]);export{S as default};
