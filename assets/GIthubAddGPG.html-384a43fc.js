...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li><p>添加子公钥:</p><p>GPG 提供了交互式添加子密钥的方法，<code>gpg --expert --edit-key [用户ID]</code> 进入交互式密钥编辑，使用 <code>addkey</code> 添加子密钥。</p></li></ul><h2 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h2>`,28),f={href:"https://zhuanlan.zhihu.com/p/137801979",target:"_blank",rel:"noopener noreferrer"},I={href:"https://www.yangqi.show/posts/gpg-github",target:"_blank",rel:"noopener noreferrer"},G={href:"https://www.bitlogs.tech/2019/01/gpg%E4%BD%BF%E7%94%A8%E6%95%99%E7%A8%8B/",target:"_blank",rel:"noopener noreferrer"};function S(_,E){const s=m("ExternalLinkIcon");return b(),g("div",null,[k,n("p",null,[h,e("：在 GitHub 中添加 GPG 公钥。具体步骤参照 "),n("a",x,[e("这里"),a(s)])]),y,n("ul",null,[n("li",null,[n("a",f,[e("简明 GPG 概念"),a(s)])]),n("li",null,[n("a",I,[e("使用 GPG 为 GIthub 签名"),a(s)])]),n("li",null,[n("a",G,[e("GPG 教程"),a(s)])])])])}const D=l(v,[["render",S],["__file","GIthubAddGPG.html.vue"]]);export{D as default};
