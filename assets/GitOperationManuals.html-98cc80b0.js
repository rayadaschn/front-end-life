...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ul><h3 id="特殊情况-revert" tabindex="-1"><a class="header-anchor" href="#特殊情况-revert" aria-hidden="true">#</a> 特殊情况 Revert</h3><p>在版本回退中的格式为：</p><p><strong>Header</strong>： <code>revert: feat(pencil): add &#39;graphiteWidth&#39; option</code></p><p><strong>Body</strong>： <code>This reverts commit (SHA 标识符).</code></p>`,80),g={id:"利用-git-gz-规范代码提交",tabindex:"-1"},b=n("a",{class:"header-anchor",href:"#利用-git-gz-规范代码提交","aria-hidden":"true"},"#",-1),h={href:"https://cz-git.qbb.sh/zh/guide",target:"_blank",rel:"noopener noreferrer"},k=i(`<ul><li>全局安装 <code>commitizen</code>,如此一来可以快速使用 <code>cz</code> 或 <code>git cz</code> 命令进行启动。</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> commitizen
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,6),f={href:"https://github.com/conventional-changelog/conventional-changelog/tree/master/packages/conventional-changelog-cli",target:"_blank",rel:"noopener noreferrer"},x=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> conventional-changelog-cli
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h2>`,3),$={href:"https://jdf2e.github.io/jdc_fe_guide/docs/git/branch",target:"_blank",rel:"noopener noreferrer"},_={href:"https://www.runoob.com/git/git-basic-operations.html",target:"_blank",rel:"noopener noreferrer"},q={href:"https://godbasin.github.io/2019/11/10/change-log/",target:"_blank",rel:"noopener noreferrer"},G={href:"https://www.ruanyifeng.com/blog/2012/07/git.html",target:"_blank",rel:"noopener noreferrer"},y={href:"https://segmentfault.com/q/1010000002477106",target:"_blank",rel:"noopener noreferrer"};function C(w,E){const a=c("ExternalLinkIcon");return l(),o("div",null,[d,n("h2",p,[u,s(),n("a",m,[s("常用的 GIT 操作指令"),e(a)])]),v,n("h2",g,[b,s(" 利用 "),n("a",h,[s("git-gz"),e(a)]),s(" 规范代码提交")]),k,n("ul",null,[n("li",null,[s("自动生成 "),n("strong",null,[n("a",f,[s("CHANGELOG–conventional-changelog-cli"),e(a)])])])]),x,n("ul",null,[n("li",null,[n("a",$,[s(" JDC 前端代码规范 (jdf2e.github.io)"),e(a)])]),n("li",null,[n("a",_,[s("Git 基本操作 "),e(a)])]),n("li",null,[n("a",q,[s("前端 CHANGELOG 生成指南"),e(a)])]),n("li",null,[n("a",G,[s("Git 分支管理"),e(a)])]),n("li",null,[n("a",y,[s("Git --no--ff"),e(a)])])])])}const A=t(r,[["render",C],["__file","GitOperationManuals.html.vue"]]);export{A as default};
