import{_ as o,Z as c,a0 as r,F as d,a1 as p,a2 as u,X as m,Y as v,$ as g}from"./framework-97fa2d96.js";const b={},n=c,s=r,t=d,a=p,h=u,i=g,k=m,f=v,x=n("h2",{id:"新建项目操作",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#新建项目操作","aria-hidden":"true"},"#"),s(" 新建项目操作")],-1),$=n("li",null,[n("p",null,[s("克隆项目到本地："),n("code",null,"git clone xxxxx"),s(" ；")])],-1),_=n("p",null,"设置 Git 用户信息：",-1),G=n("li",null,[n("p",null,[s("设置用户名: "),n("code",null,'git config user.name "yourName"')])],-1),y=n("p",null,[s("设置用户邮箱："),n("code",null,'git config user.email "123xxx678+yourEmail@users.noreply.github.com"')],-1),q=n("code",null,"noreply",-1),C={href:"https://docs.github.com/zh/enterprise-cloud@latest/account-and-profile/setting-up-and-managing-your-personal-account-on-github/managing-email-preferences/setting-your-commit-email-address",target:"_blank",rel:"noopener noreferrer"},E=n("p",null,"设置 GPG 签名：",-1),w=i(`<ul><li><p>列出本地公钥:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: gpg --list-keys
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>git merge</code> 和 <code>git merge --no--ff</code> 的区别：</p><ul><li><code>fast-forward</code>，默认使用，<strong>保留分支的提交记录，但不会生成合并的提交记录。</strong> 新特性分支删除后，会丢失分支信息。</li><li><code>–no-ff</code>，关闭<code>fast-forward</code>模式，在提交时，<strong>保留分支的<code>commit</code>历史，并生成一次合并的提交记录。</strong></li><li><code>--squash</code>，将多次分支<code>commit</code>历史压缩为一次，合并的时候相当于提交一次额外的 <code>commit</code> 进行总结。</li></ul><figure><img src="https://image-static.segmentfault.com/120/030/1200301748-54c88abc9ed57_fix732" alt="git merge几种模式" tabindex="0" loading="lazy"><figcaption>git merge几种模式</figcaption></figure><h4 id="_2-本地与远程端的交互" tabindex="-1"><a class="header-anchor" href="#_2-本地与远程端的交互" aria-hidden="true">#</a> 2. 本地与远程端的交互</h4><p>正常流程是，查看状态、拉取、修改代码后，推送</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>// 远端数据库操作
...
$: <span class="token function">git</span> commit <span class="token parameter variable">-m</span> <span class="token punctuation">[</span>message<span class="token punctuation">]</span>
$: <span class="token function">git</span> push
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>若你和同事的分支不同，此时并不是用 <code>git pull</code> 同步代码， 而是用</p><p>个人使用，已经写完代码了，用方案 1 推送；还未写完，则用方案 2 临时贮藏。</p><h3 id="版本回退" tabindex="-1"><a class="header-anchor" href="#版本回退" aria-hidden="true">#</a> 版本回退</h3><blockquote><p>版本回退需注意 <code>git revert</code> 和 <code>git reset</code> 的区别</p></blockquote><ul><li><code>git revert</code><strong>git revert</strong> 撤销某次操作，此次<strong>操作之前和之后的 commit 和 history 都会保留</strong>，并且把这次撤销作为一次最新的提交。git revert 是提交一个新的版本，将需要 revert 的版本的内容再反向修改回去，版本会递增，不影响之前提交的内容。</li></ul><ol><li>当代码已经 commit 但没有 push 时，可使用如下命令操作： <code>git revert HEAD //撤销倒数第一次提交</code><code>git revert HEAD^ //撤销倒数第二次提交</code><code>git-revert HEAD~2 //撤销倒数第三次提交</code><code>git revert commit //（比如：fa042ce57ebbxxxxxxxxxxx2c58ee7ff）撤销指定的版本，撤销也会作为一次提交进</code></li><li>当代码已经 commit 并 push 时，可使用如下命令： <code>git revert HEAD~1 //代码回退到前一个版本</code></li></ol><p>当回退有冲突时，需手动合并冲突并进行修改，再 commit 和 push。<strong>这相当于增加了一次新的提交并且版本库中有记录。</strong></p><ul><li><p><strong><code>git reset</code> 推荐！！！</strong></p><p><strong>git reset</strong> 是撤销某次提交，但是<strong>此次之后的修改都会被退回到暂存区</strong>。除了默认的 mixed 模式，还有 soft 和 hard 模式。</p><blockquote><p><strong>--soft</strong>： <strong>不删除</strong>工作空间改动代码，<strong>撤销 commit</strong>，<strong>不撤销 <code>git add .</code></strong></p><p><strong>--hard</strong>： <strong>删除</strong>工作空间改动代码，<strong>撤销 commit</strong>，<strong>撤销<code>git add .</code></strong></p><ul><li>注意完成这个操作后，就恢复到了上一次的 commit 状态。</li></ul><p><strong>--mixed</strong>：【默认参数】<strong>不删除</strong>工作空间改动代码，<strong>撤销 commit</strong>，<strong>撤销<code>git add .</code></strong></p><p>简单的讲，正常提交是： <code>git add .</code> --&gt; <code>git commit</code></p><p>对应的回退版本是: <code>git reset --soft</code> --&gt; <code>git reset --mixed</code></p><ul><li>撤销 <code>commit</code> ： <code>git reset --soft HEAD^</code></li><li>撤销 <code>commit</code> 且 撤销贮藏 <code>add .</code> ： <code>git reset HEAD^</code></li><li>撤销全部提交且删除改动代码（慎重）： <code>git reset --hard HEAD^</code></li></ul></blockquote></li></ul><ol><li>如果我们的有两次 commit 但是没有 push 代码</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">git</span> reset HEAD~1      //撤销前一次 commit，所有代码回到 Working Copy
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol start="4"><li>假如我们有几次代码修改，并且都<strong>已经 push 到了版本库</strong>中。</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">git</span> reset <span class="token parameter variable">--hard</span> HEAD~2   //本地的Wroking Copy回退到2个版本之前。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>注意！当我们使用强制指令时，若在远程的该分支中有他人的贡献，<code>--force</code> 是会覆盖掉他人的代码的，所以为了保险起见，应当用 <code>--force-with-lease</code> 。</p></blockquote><ol start="5"><li>只回退某个指定文件到指定版本</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">git</span> reset a4e21523xxxxxxxxx68e9976948a35e <span class="token punctuation">[</span>options<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol start="6"><li>回退到指定版本</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">git</span> reset <span class="token parameter variable">--hard</span> commitId（通过git log可查看提交的commitId）
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>汇总</strong>：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 恢复暂存区的指定文件到工作区</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><code>git config</code>：Git 命令行工具的配置命令。</li><li><code>--global</code>：表示该配置是全局性质的，会应用在你的所有代码仓库中。</li><li><code>http.https://github.com.proxy</code> ：作为配置项名称，它表示对应的是使用 HTTPS 协议访问 GitHub 并需要进行代理配置。</li><li><code>socks5://127.0.0.1:7891</code>：代理服务器的地址和端口号。其中，socks5 表示使用 SOCKS5 协议进行代理，<code>127.0.0.1</code> 指的是代理服务器的 IP 地址或主机名，7891 则是端口号(Clashx 中 socks5 默认端口)。你需要根据自己实际的代理情况进行相应的修改，并保证对应的代理能够正常工作。</li></ul><p>取消代理：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 取消全局代理</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ul><h3 id="特殊情况-revert" tabindex="-1"><a class="header-anchor" href="#特殊情况-revert" aria-hidden="true">#</a> 特殊情况 Revert</h3><p>在版本回退中的格式为：</p><p><strong>Header</strong>： <code>revert: feat(pencil): add &#39;graphiteWidth&#39; option</code></p><p><strong>Body</strong>： <code>This reverts commit (SHA 标识符).</code></p>`,89),I={id:"利用-git-gz-规范代码提交",tabindex:"-1"},z=n("a",{class:"header-anchor",href:"#利用-git-gz-规范代码提交","aria-hidden":"true"},"#",-1),L={href:"https://cz-git.qbb.sh/zh/guide",target:"_blank",rel:"noopener noreferrer"},O=i(`<ul><li>全局安装 <code>commitizen</code>,如此一来可以快速使用 <code>cz</code> 或 <code>git cz</code> 命令进行启动。</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> commitizen
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,6),R={href:"https://github.com/conventional-changelog/conventional-changelog/tree/master/packages/conventional-changelog-cli",target:"_blank",rel:"noopener noreferrer"},P=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> conventional-changelog-cli
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h2>`,3),S={href:"https://jdf2e.github.io/jdc_fe_guide/docs/git/branch",target:"_blank",rel:"noopener noreferrer"},V={href:"https://www.runoob.com/git/git-basic-operations.html",target:"_blank",rel:"noopener noreferrer"},T={href:"https://godbasin.github.io/2019/11/10/change-log/",target:"_blank",rel:"noopener noreferrer"},F={href:"https://www.ruanyifeng.com/blog/2012/07/git.html",target:"_blank",rel:"noopener noreferrer"},j={href:"https://segmentfault.com/q/1010000002477106",target:"_blank",rel:"noopener noreferrer"};function M(Y,K){const e=t("ExternalLinkIcon"),l=t("RouterLink");return k(),f("div",null,[x,n("ol",null,[$,n("li",null,[_,n("ul",null,[G,n("li",null,[y,n("p",null,[q,s("为隐私邮箱，具体设置可看"),n("a",C,[s("GitHub 设置提交电子邮箱地址"),a(e)])])])])]),n("li",null,[E,n("p",null,[s("若无 GPG 秘钥，可看 "),a(l,{to:"/SystemRequirements/GIthubAddGPG.html"},{default:h(()=>[s("GIthub 添加 GPG 签名")]),_:1}),s(" 一文。")]),w])]),N,n("h2",H,[A,s(),n("a",B,[s("常用的 GIT 操作指令"),a(e)])]),D,n("h2",I,[z,s(" 利用 "),n("a",L,[s("git-gz"),a(e)]),s(" 规范代码提交")]),O,n("ul",null,[n("li",null,[s("自动生成 "),n("strong",null,[n("a",R,[s("CHANGELOG–conventional-changelog-cli"),a(e)])])])]),P,n("ul",null,[n("li",null,[n("a",S,[s("JDC 前端代码规范 (jdf2e.github.io)"),a(e)])]),n("li",null,[n("a",V,[s("Git 基本操作"),a(e)])]),n("li",null,[n("a",T,[s("前端 CHANGELOG 生成指南"),a(e)])]),n("li",null,[n("a",F,[s("Git 分支管理"),a(e)])]),n("li",null,[n("a",j,[s("Git --no--ff"),a(e)])])])])}const J=o(b,[["render",M],["__file","GitOperationManuals.html.vue"]]);export{J as default};
