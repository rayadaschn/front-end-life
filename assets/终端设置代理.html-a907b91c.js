import{_ as e,V as i,W as l,X as n,a0 as s,Z as t,Y as c,F as o}from"./framework-a7fdb544.js";const p={},r=n("h1",{id:"为-macos-设置终端代理",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#为-macos-设置终端代理","aria-hidden":"true"},"#"),s(" 为 MacOS 设置终端代理")],-1),d=n("h2",{id:"环境",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#环境","aria-hidden":"true"},"#"),s(" 环境")],-1),u={href:"https://github.com/yichengchen/clashX/tags",target:"_blank",rel:"noopener noreferrer"},v=n("strong",null,"7890",-1),m=c(`<h2 id="为终端设置代理" tabindex="-1"><a class="header-anchor" href="#为终端设置代理" aria-hidden="true">#</a> 为终端设置代理</h2><ol><li><p>临时配置</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token builtin class-name">export</span> <span class="token assign-left variable">http_proxy</span><span class="token operator">=</span>http://127.0.0.1:7890
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9);function b(h,k){const a=o("ExternalLinkIcon");return i(),l("div",null,[r,d,n("p",null,[s("代理软件: "),n("a",u,[s("ClashX"),t(a)]),s(" , 软件的终端混合代理端口号默认为: "),v,s(" HTTP 代理端口号 和 Socks5 代理端口号默认未设置。")]),m])}const x=e(p,[["render",b],["__file","终端设置代理.html.vue"]]);export{x as default};
