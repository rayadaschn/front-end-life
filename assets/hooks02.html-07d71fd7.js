import{_ as n,X as s,Y as a,$ as t}from"./framework-5dd7fabc.js";const p={},e=t,o=s,c=a,l=e(`<p>该文为上篇<a href="./hooks01">《手写一个具备拖拉拽多功能的弹窗》</a>的延续。</p><p>最终效果图如下:</p><figure><img src="https://cdn.jsdelivr.net/gh/rayadaschn/blogImage@master/img/Kapture 2024-05-27 at 00.02.01.gif" alt="Canvas 绘制及拖动" tabindex="0" loading="lazy"><figcaption>Canvas 绘制及拖动</figcaption></figure><p>首先需要区分 <code>e.clientX</code> 和 <code>e.offsetX</code> 的区别:</p><ul><li><code>e.clientX</code> 是相对于整个文档左上角的坐标。</li><li><code>e.offsetX</code> 是相对于触发事件的元素左上角的坐标。</li></ul><p>设计思路:</p><ol><li>绘制获取 Canvas 元素。</li><li>创建存储绘制矩形的数组, 后续依据这个数组来遍历绘制矩阵;</li><li>创建绘制矩阵的类, 包含绘制矩阵的方法, 以及矩形的四角信息;</li><li>监听 Canvas 的鼠标按下事件 onmousedown, 分俩种情况, 一种是点击了已绘制矩形, 另一种是点击了空白处开始绘制矩形;</li><li>创建判断是否是绘制块, 创建依据遍历绘制数组, 绘制 Canvas。</li></ol><p>关键代码:</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 创建 Canvas</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>en<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">&gt;</span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
      ...
      <span class="token keyword">var</span> rectLists <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span> <span class="token comment">// 所有矩形列表, 依据这个进行绘制</span>
      <span class="token keyword">class</span> <span class="token class-name">Rectangle</span> <span class="token punctuation">{</span>
        ...
        <span class="token comment">// 更新矩形</span>
        <span class="token function">draw</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      ...
      <span class="token keyword">function</span> <span class="token function">mouseDown</span><span class="token punctuation">(</span><span class="token parameter">e</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token function">setCanXY</span><span class="token punctuation">(</span>e<span class="token punctuation">)</span> <span class="token comment">// 更新 x、y</span>
      ...
      <span class="token doc-comment comment">/** 尝试获取矩形, 判断当前 x,y 是否在已绘制矩形内, 以最开始绘制为准 */</span>
      ...
      <span class="token keyword">var</span> <span class="token function-variable function">init</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token function">bindEvent</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment">// 绑定事件</span>
        <span class="token function">drawAllRect</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment">// 绘制所有矩形</span>
      <span class="token punctuation">}</span>
