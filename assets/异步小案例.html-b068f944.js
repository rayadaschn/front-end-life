import{_ as n,V as s,W as a,Y as e}from"./framework-a7fdb544.js";const t={},i=e(`<h1 id="异步小案例" tabindex="-1"><a class="header-anchor" href="#异步小案例" aria-hidden="true">#</a> 异步小案例</h1><h2 id="红绿灯控制任务" tabindex="-1"><a class="header-anchor" href="#红绿灯控制任务" aria-hidden="true">#</a> 红绿灯控制任务</h2><p>红灯 3s 亮一次，绿灯 1s 亮一次，黄灯 2s 亮一次，如果让 3 个灯不断交替地重复亮呢？</p><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript"><pre class="language-JavaScript"><code>function red() {
    console.log(&#39;red&#39;);
}
