import{_ as o,V as c,W as r,X as n,Y as s,Z as a,a0 as d,$ as i,F as t}from"./framework-2060dede.js";const p={},u=n("h1",{id:"git-操作手册指南",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#git-操作手册指南","aria-hidden":"true"},"#"),s(" Git 操作手册指南")],-1),m=n("h2",{id:"新建项目操作",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#新建项目操作","aria-hidden":"true"},"#"),s(" 新建项目操作")],-1),v=n("li",null,[n("p",null,[s("克隆项目到本地："),n("code",null,"git clone xxxxx"),s(" ；")])],-1),g=n("p",null,"设置 Git 用户信息：",-1),b=n("li",null,[n("p",null,[s("设置用户名: "),n("code",null,'git config user.name "yourName"')])],-1),h=n("p",null,[s("设置用户邮箱："),n("code",null,'git config user.email "123xxx678+yourEmail@users.noreply.github.com"')],-1),k=n("code",null,"noreply",-1),f={href:"https://docs.github.com/zh/enterprise-cloud@latest/account-and-profile/setting-up-and-managing-your-personal-account-on-github/managing-email-preferences/setting-your-commit-email-address",target:"_blank",rel:"noopener noreferrer"},x=n("p",null,"设置 GPG 签名：",-1),$=i(`<ul><li><p>列出本地公钥:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: gpg --list-keys
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ul><h3 id="特殊情况-revert" tabindex="-1"><a class="header-anchor" href="#特殊情况-revert" aria-hidden="true">#</a> 特殊情况 Revert</h3><p>在版本回退中的格式为：</p><p><strong>Header</strong>： <code>revert: feat(pencil): add &#39;graphiteWidth&#39; option</code></p><p><strong>Body</strong>： <code>This reverts commit (SHA 标识符).</code></p>`,80),E={id:"利用-git-gz-规范代码提交",tabindex:"-1"},w=n("a",{class:"header-anchor",href:"#利用-git-gz-规范代码提交","aria-hidden":"true"},"#",-1),A={href:"https://cz-git.qbb.sh/zh/guide",target:"_blank",rel:"noopener noreferrer"},H=i(`<ul><li>全局安装 <code>commitizen</code>,如此一来可以快速使用 <code>cz</code> 或 <code>git cz</code> 命令进行启动。</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> commitizen
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,6),D={href:"https://github.com/conventional-changelog/conventional-changelog/tree/master/packages/conventional-changelog-cli",target:"_blank",rel:"noopener noreferrer"},N=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> conventional-changelog-cli
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h2>`,3),B={href:"https://jdf2e.github.io/jdc_fe_guide/docs/git/branch",target:"_blank",rel:"noopener noreferrer"},I={href:"https://www.runoob.com/git/git-basic-operations.html",target:"_blank",rel:"noopener noreferrer"},z={href:"https://godbasin.github.io/2019/11/10/change-log/",target:"_blank",rel:"noopener noreferrer"},L={href:"https://www.ruanyifeng.com/blog/2012/07/git.html",target:"_blank",rel:"noopener noreferrer"},O={href:"https://segmentfault.com/q/1010000002477106",target:"_blank",rel:"noopener noreferrer"};function R(F,P){const e=t("ExternalLinkIcon"),l=t("RouterLink");return c(),r("div",null,[u,m,n("ol",null,[v,n("li",null,[g,n("ul",null,[b,n("li",null,[h,n("p",null,[k,s("为隐私邮箱，具体设置可看"),n("a",f,[s("GitHub 设置提交电子邮箱地址"),a(e)])])])])]),n("li",null,[x,n("p",null,[s("若无 GPG 秘钥，可看 "),a(l,{to:"/SystemRequirements/GIthubAddGPG.html"},{default:d(()=>[s("GIthub 添加 GPG 签名")]),_:1}),s(" 一文。")]),$])]),_,n("h2",G,[y,s(),n("a",q,[s("常用的 GIT 操作指令"),a(e)])]),C,n("h2",E,[w,s(" 利用 "),n("a",A,[s("git-gz"),a(e)]),s(" 规范代码提交")]),H,n("ul",null,[n("li",null,[s("自动生成 "),n("strong",null,[n("a",D,[s("CHANGELOG–conventional-changelog-cli"),a(e)])])])]),N,n("ul",null,[n("li",null,[n("a",B,[s(" JDC 前端代码规范 (jdf2e.github.io)"),a(e)])]),n("li",null,[n("a",I,[s("Git 基本操作 "),a(e)])]),n("li",null,[n("a",z,[s("前端 CHANGELOG 生成指南"),a(e)])]),n("li",null,[n("a",L,[s("Git 分支管理"),a(e)])]),n("li",null,[n("a",O,[s("Git --no--ff"),a(e)])])])])}const V=o(p,[["render",R],["__file","GitOperationManuals.html.vue"]]);export{V as default};
