import{_ as o,X as c,Z as r,$ as d,a0 as p,V as u,W as m,F as v,Y as g}from"./framework-2eee3422.js";const b={},n=c,s=r,t=v,a=d,h=p,i=g,k=u,f=m,x=n("h1",{id:"git-操作手册指南",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#git-操作手册指南","aria-hidden":"true"},"#"),s(" Git 操作手册指南")],-1),$=n("h2",{id:"新建项目操作",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#新建项目操作","aria-hidden":"true"},"#"),s(" 新建项目操作")],-1),_=n("li",null,[n("p",null,[s("克隆项目到本地："),n("code",null,"git clone xxxxx"),s(" ；")])],-1),G=n("p",null,"设置 Git 用户信息：",-1),y=n("li",null,[n("p",null,[s("设置用户名: "),n("code",null,'git config user.name "yourName"')])],-1),q=n("p",null,[s("设置用户邮箱："),n("code",null,'git config user.email "123xxx678+yourEmail@users.noreply.github.com"')],-1),C=n("code",null,"noreply",-1),E={href:"https://docs.github.com/zh/enterprise-cloud@latest/account-and-profile/setting-up-and-managing-your-personal-account-on-github/managing-email-preferences/setting-your-commit-email-address",target:"_blank",rel:"noopener noreferrer"},w=n("p",null,"设置 GPG 签名：",-1),N=i(`<ul><li><p>列出本地公钥:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: gpg --list-keys
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><code>git config</code>：Git 命令行工具的配置命令。</li><li><code>--global</code>：表示该配置是全局性质的，会应用在你的所有代码仓库中。</li><li><code>http.https://github.com.proxy</code> ：作为配置项名称，它表示对应的是使用 HTTPS 协议访问 GitHub 并需要进行代理配置。</li><li><code>socks5://127.0.0.1:7890</code>：代理服务器的地址和端口号。其中，socks5 表示使用 SOCKS5 协议进行代理，<code>127.0.0.1</code> 指的是代理服务器的 IP 地址或主机名，7890 则是端口号。你需要根据自己实际的代理情况进行相应的修改，并保证对应的代理能够正常工作。</li></ul><p>取消代理：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 取消全局代理</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ul><h3 id="特殊情况-revert" tabindex="-1"><a class="header-anchor" href="#特殊情况-revert" aria-hidden="true">#</a> 特殊情况 Revert</h3><p>在版本回退中的格式为：</p><p><strong>Header</strong>： <code>revert: feat(pencil): add &#39;graphiteWidth&#39; option</code></p><p><strong>Body</strong>： <code>This reverts commit (SHA 标识符).</code></p>`,89),z={id:"利用-git-gz-规范代码提交",tabindex:"-1"},L=n("a",{class:"header-anchor",href:"#利用-git-gz-规范代码提交","aria-hidden":"true"},"#",-1),O={href:"https://cz-git.qbb.sh/zh/guide",target:"_blank",rel:"noopener noreferrer"},R=i(`<ul><li>全局安装 <code>commitizen</code>,如此一来可以快速使用 <code>cz</code> 或 <code>git cz</code> 命令进行启动。</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$: <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> commitizen
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h2>`,3),S={href:"https://jdf2e.github.io/jdc_fe_guide/docs/git/branch",target:"_blank",rel:"noopener noreferrer"},T={href:"https://www.runoob.com/git/git-basic-operations.html",target:"_blank",rel:"noopener noreferrer"},F={href:"https://godbasin.github.io/2019/11/10/change-log/",target:"_blank",rel:"noopener noreferrer"},j={href:"https://www.ruanyifeng.com/blog/2012/07/git.html",target:"_blank",rel:"noopener noreferrer"},Y={href:"https://segmentfault.com/q/1010000002477106",target:"_blank",rel:"noopener noreferrer"};function K(M,W){const e=t("ExternalLinkIcon"),l=t("RouterLink");return k(),f("div",null,[x,$,n("ol",null,[_,n("li",null,[G,n("ul",null,[y,n("li",null,[q,n("p",null,[C,s("为隐私邮箱，具体设置可看"),n("a",E,[s("GitHub 设置提交电子邮箱地址"),a(e)])])])])]),n("li",null,[w,n("p",null,[s("若无 GPG 秘钥，可看 "),a(l,{to:"/SystemRequirements/GIthubAddGPG.html"},{default:h(()=>[s("GIthub 添加 GPG 签名")]),_:1}),s(" 一文。")]),N])]),H,n("h2",A,[B,s(),n("a",D,[s("常用的 GIT 操作指令"),a(e)])]),I,n("h2",z,[L,s(" 利用 "),n("a",O,[s("git-gz"),a(e)]),s(" 规范代码提交")]),R,n("ul",null,[n("li",null,[s("自动生成 "),n("strong",null,[n("a",V,[s("CHANGELOG–conventional-changelog-cli"),a(e)])])])]),P,n("ul",null,[n("li",null,[n("a",S,[s("JDC 前端代码规范 (jdf2e.github.io)"),a(e)])]),n("li",null,[n("a",T,[s("Git 基本操作"),a(e)])]),n("li",null,[n("a",F,[s("前端 CHANGELOG 生成指南"),a(e)])]),n("li",null,[n("a",j,[s("Git 分支管理"),a(e)])]),n("li",null,[n("a",Y,[s("Git --no--ff"),a(e)])])])])}const X=o(b,[["render",K],["__file","GitOperationManuals.html.vue"]]);export{X as default};
