<template><div><h1 id="为-macos-设置终端代理" tabindex="-1"><a class="header-anchor" href="#为-macos-设置终端代理" aria-hidden="true">#</a> 为 MacOS 设置终端代理</h1>
<h2 id="环境" tabindex="-1"><a class="header-anchor" href="#环境" aria-hidden="true">#</a> 环境</h2>
<p>代理软件: <a href="https://github.com/yichengchen/clashX/tags" target="_blank" rel="noopener noreferrer">ClashX<ExternalLinkIcon/></a> , 软件的终端混合代理端口号默认为: <strong>7890</strong>
HTTP 代理端口号 和 Socks5 代理端口号默认未设置。</p>
<h2 id="为终端设置代理" tabindex="-1"><a class="header-anchor" href="#为终端设置代理" aria-hidden="true">#</a> 为终端设置代理</h2>
<ol>
<li>
<p>临时配置</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>$: <span class="token builtin class-name">export</span> <span class="token assign-left variable">http_proxy</span><span class="token operator">=</span>http://127.0.0.1:7890
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 脚本内容</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>指令脚本，我们一般写在 <code v-pre>~/.bash_profile</code> 内，因此，我们可以在终端输入如下指令，自动创建该文件。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">cat</span> <span class="token operator">></span> ~/.bash_profile <span class="token operator">&lt;&lt;</span> <span class="token string">EOF
function proxy_on() {
...
<p>到此，我们已经完成了终端代理的设置了，可以进行验证，在 新建 终端内输入：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 开启代理</span>
$: proxy_on

<span class="token comment"># 关闭代理</span>
$: proxy_off
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="其它-为-github-设置代理" tabindex="-1"><a class="header-anchor" href="#其它-为-github-设置代理" aria-hidden="true">#</a> 其它： 为 GIthub 设置代理</h2>
<p>走 Github 下载时， 自动终端代理</p>
<p>在 <code v-pre>~/.ssh/config</code> 文件中追加设置。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 全局</span>
