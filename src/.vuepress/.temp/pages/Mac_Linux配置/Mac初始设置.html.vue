...
<h3 id="通用设置" tabindex="-1"><a class="header-anchor" href="#通用设置" aria-hidden="true">#</a> 通用设置</h3>
<ol>
<li>
<p>桌面、屏保和触发角</p>
</li>
...
<p>工具类</p>
<ol>
<li><strong>柠檬清理</strong> 官网下载</li>
<li>the unarchiver 优秀的解压软件,应用商店下载</li>
<li>Google Chrome</li>
...
<li><strong><a href="https://maccy.app/" target="_blank" rel="noopener noreferrer">Maccy<ExternalLinkIcon/></a></strong> 优秀的剪切板工具</li>
<li><strong>Hidden Bar</strong> 隐藏菜单栏过多, 应用商店下载。</li>
<li>Drink 提示喝水, 应用商店下载</li>
<li>欧路词典</li>
<li>有道云笔记</li>
<li>Photoshop</li>
<li>Finally Cut Pro</li>
<li>Compressor 视频导出</li>
<li>XMind: 脑图</li>
</ol>
</li>
<li>
...
<h2 id="开发者" tabindex="-1"><a class="header-anchor" href="#开发者" aria-hidden="true">#</a> 开发者</h2>
<ol>
<li>
<p><a href="https://zhuanlan.zhihu.com/p/111014448" target="_blank" rel="noopener noreferrer">Homebrew<ExternalLinkIcon/></a></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 若无法正常下载, 还需为 git 添加可信任的三个文件目录</span>
...
<li>
<p><a href="https://sliu.vip/notes/iterm2/" target="_blank" rel="noopener noreferrer">iTerm2 + oh-my-zsh + agnoster 配置 <ExternalLinkIcon/></a></p>
</li>
<li>
<p>Git</p>
</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 利用curl 直接全局安装 pnpm</span>
