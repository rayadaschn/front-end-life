<template><div><h1 id="gitlab-操作手册指南" tabindex="-1"><a class="header-anchor" href="#gitlab-操作手册指南" aria-hidden="true">#</a> GitLab 操作手册指南</h1>
<p>[toc]</p>
...
<p>当回退有冲突时，需手动合并冲突并进行修改，再 commit 和 push。<strong>这相当于增加了一次新的提交并且版本库中有记录。</strong></p>
<ul>
<li>
<p><strong><code v-pre>git reset</code> 推荐!!!!</strong>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="修改-commit" tabindex="-1"><a class="header-anchor" href="#修改-commit" aria-hidden="true">#</a> 修改 Commit</h3>
<ol>
<li>列出 commit 列表:
...
<p>Commit message 都包括三个部分：<strong>Header</strong> (必须)，Body 和 Footer。</p>
...
- subject<span class="token punctuation">(</span>可选<span class="token punctuation">))</span>
  - 是 <span class="token variable"><span class="token variable">`</span>commit<span class="token variable">`</span></span> 目的的简短描述，不超过50个字符。
    ...
    - 第一个字母小写
    - 结尾不加句号（.）
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="body" tabindex="-1"><a class="header-anchor" href="#body" aria-hidden="true">#</a> Body</h3>
<p><strong>Body</strong> 为此次提交的详细描述，可多行显示。</p>
<ul>
<li>使用第一人称现在时，比如使用<code v-pre>change</code>而不是<code v-pre>changed</code>或<code v-pre>changes</code>。</li>
<li>应该说明代码变动的动机，以及与以前行为的对比。</li>
</ul>
<h3 id="footer" tabindex="-1"><a class="header-anchor" href="#footer" aria-hidden="true">#</a> Footer</h3>
<p><strong>Footer</strong> 仅在 <strong>不兼容变动</strong> 和 <strong>关闭 issue</strong> 时 使用：</p>
<ul>
<li>
<p>不兼容变动</p>
...
<li>
<p>关闭 Issue</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>Closes <span class="token comment">#996, #007</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ul>
<h3 id="特殊情况-revert" tabindex="-1"><a class="header-anchor" href="#特殊情况-revert" aria-hidden="true">#</a> 特殊情况 Revert</h3>
<p>在版本回退中的格式为：</p>
<p><strong>Header</strong>： <code v-pre>revert: feat(pencil): add 'graphiteWidth' option</code></p>
<p><strong>Body</strong>： <code v-pre>This reverts commit (SHA 标识符).</code></p>
<h2 id="利用-git-gz-规范代码提交" tabindex="-1"><a class="header-anchor" href="#利用-git-gz-规范代码提交" aria-hidden="true">#</a> 利用 <a href="https://cz-git.qbb.sh/zh/guide" target="_blank" rel="noopener noreferrer">git-gz<ExternalLinkIcon/></a> 规范代码提交</h2>
<ul>
...
<li>
<p>下载依赖 <strong>cz-git</strong></p>
<p>用 <code v-pre>git cz</code> 代替 <code v-pre>git commit</code> ，生成 Commit message。</p>
</li>
</ul>
...
<li>自动生成 <strong><a href="https://github.com/conventional-changelog/conventional-changelog/tree/master/packages/conventional-changelog-cli" target="_blank" rel="noopener noreferrer">CHANGELOG–conventional-changelog-cli<ExternalLinkIcon/></a></strong></li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>$: <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> conventional-changelog-cli
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 自动生成 CHANGELOG.md 文件</span>
