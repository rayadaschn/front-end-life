...
<h3 id="eslint-配合-vscode-插件使用" tabindex="-1"><a class="header-anchor" href="#eslint-配合-vscode-插件使用" aria-hidden="true">#</a> ESlint 配合 VScode 插件使用</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>即，保存文件时执行——”ESLint 自动修复文件“。</p>
